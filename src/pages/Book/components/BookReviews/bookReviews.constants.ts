export const BOOK_REVIEWS_TEXTS = {
    YOUR_REVIEW_BADGE: 'Your Review',
    EDIT: 'Edit',
    DELETE: 'Delete',
    WRITE_REVIEW: 'Write a Review',
    COMMUNITY_REVIEWS_TITLE: 'Community Reviews',
    SORT_BY: 'Sort by:',
...
export const YOUR_REVIEW = {
    ratingLabel: 'You rated it 5 stars',
    writtenOn: 'Written on Oct 24, 2025',
    heading: 'An absolute masterpiece of hard science fiction.',
    body: '"I haven\'t felt this much wonder reading a book in years. The technical details are fascinating but the heart of the story—the connection between the characters—is what truly stays with you. Weir has outdone himself."',
};

export const GLOBAL_RATING_SUMMARY = {
    score: '4.7',
    totalReviews: '12,482 total reviews',
};
